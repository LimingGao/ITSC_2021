...
% 1. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function fcn_plotspeed_both(speed,speed_without_preview,station,errorLateralOffset_without_preview);
...
plot(station(1:index(1)),speed_without_preview(1+offset:index(1)+offset),'r:','MarkerSize',6,'LineWidth',2.3);


plot(station(index(1)),speed_without_preview(index(1)+offset),'rx','MarkerSize',20,'LineWidth',2.3);

annotation(h_fig,'textbox',...
    [0.310666666666668 0.690999998664852 0.116 0.0893333346684773],...
    'String',{'Crash'},...
    'LineStyle','none',...
    'FontSize',12,...
