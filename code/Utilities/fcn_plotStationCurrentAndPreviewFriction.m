%%%%%%%%%%%%%%%%%%%%%  Function fcn_plotStationCurrentAndPreviewFriction %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Purpose:
%      plot the tation of cg postion, current friction and preview friction
%
% Input Variables:
...
function fcn_plotStationCurrentAndPreviewFriction(P_CG,friction_coeffs,preview_friction,varargin)
...
if nargin == 3
    ...
    plot(station_cg,friction_coeffs(:,3),'yd','MarkerSize',6)
    plot(station_cg,friction_coeffs(:,4),'cp','MarkerSize',6)
    
    plot(station_cg,preview_friction(:,3),'b.','MarkerSize',14);
