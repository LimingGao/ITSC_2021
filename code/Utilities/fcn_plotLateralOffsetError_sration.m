%%%%%%%%%%%%%%%%%%% Function fcn_plotLateralOffsetError_sration %%%%%%%%%%%%%%%%%%%
...
% 1.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function fcn_plotLateralOffsetError_sration(station_cg,errorLateralOffset,varargin)
...
if length(errorLateralOffset) ~= length(station_cg)
...
if nargin ==3
    ...
    plot(station_cg,errorLateralOffset,'b-','MarkerSize',6,'LineWidth',1.5);
    plot(station_cg,lateral_error,'k-','MarkerSize',6,'LineWidth',1.5);
